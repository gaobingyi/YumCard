...
import com.yum.card.service.CardInfoService;

/**
 * Servlet implementation class QueryCardInfoServlet
 */
@WebServlet("/QueryCardInfoServlet")
public class QueryCardInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryCardInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pager pager = cis.getPager(queryParameter_new, parameterType);
		...
		ArrayList<CardInfo> cardInfoList = cis.getCardInfo(queryParameter_new, parameterType, pager);
		...
		request.getRequestDispatcher("query_card_info_users.jsp")
