...
#cardbin,#balance,#operation_code{
	width:250px;
}
span{
	color:red;
  ...
  <div id="mainbody"><!-- 主体  -->
    <div id="sidebar"><!-- 侧边导航栏  -->
      ...
      <dl>
		...
		<dd class="current"><a href="adjust_card_balance.jsp">调整卡余额</a></dd>
		<dd><a href="#">******</a></dd>
        <dd><a href="#">******</a></dd>
      </dl>    
    </div>
    <div id="content"><!-- 内容  -->	
      ...
      <dt>调整卡余额</dt>
      <dd><!-- 存放查询输入框 -->	
  		<form action="/YumCard/AdjustCardBalanceServlet" method="post">
				<label>卡&nbsp;&nbsp;&nbsp;号</label>
				<input id="cardbin" type="text" name="cardbin"
				placeholder="请输入卡号">
				<br>
				<label>金&nbsp;&nbsp;&nbsp;额</label>
      ...
      <dd ><!-- 存放查询结果（表格）-->
			...
			if (errorMessage != null) {
				...
				%>
				<table id="customers">
				<tr><th>卡号</th><th>调整前余额</th><th>调整后余额</th></tr>
				<tr>
					<td><%=adjustBalanceResult.getCard()%></td>
					<td><%=adjustBalanceResult.getCard_balance_before()/100.0%></td>
					<td><%=adjustBalanceResult.getCard_balance_after()/100.0%></td>
				</tr>
				</table>
				<%
				}
